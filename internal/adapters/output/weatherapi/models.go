...
// API-specific response models that match the external WeatherAPI.com JSON structure
// These models are separate from domain models to avoid polluting domain with JSON tags
